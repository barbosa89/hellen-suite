    ...
    <div id="page-wrapper">
        ...
        <div class="row mt-4">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <form action="{{ route('assets.maintenance.update', ['id' => id_encode($asset->id), 'maintenance' => id_encode($asset->maintenances->first()->id)]) }}" method="POST" enctype="multipart/form-data">
                    @csrf()
