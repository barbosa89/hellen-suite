    ...
    <div class="main">
        ...
        <div class="main-w3lsrow">
            ...
            <div class="login-form login-form-left">
                <div class="agile-row">
                    <div class="head">
                        <h2>@lang('login.activateTitle')</h2>
                        <span class="fa fa-lock"></span>
                    </div>
                    <div class="clear"></div>
                    <div class="login-agileits-top">
                        <form action="{{ route('accounts.activation') }}" method="post">
                            @csrf
                            ...
                            <div class="form-group{{ $errors->has('token') ? ' is-invalid' : '' }}">
                                <input class="w-input" type="token" class="token" name="token" placeholder="token" required=""/>
                            ...
                            <input type="submit" value="@lang('login.activate')">
                        </form>
                    </div>
